...
public class Class03BuscadorPlantillaFuncion {
    public static void main(String[] args) {
        ...
        try {
                ...
                // String sql = "select FUNCION, where FUNCION==" + f + " from PLANTILLA order by SALARIO";
                String sql = "select APELLIDO, FUNCION, SALARIO from PLANTILLA where FUNCION='" + f + " ' order by SALARIO";//ojo escape de commillas
